...
public class FragmentEditUserProfile extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        editTextFirstName = view.findViewById(R.id.editUserFirstName);
        editTextDate = view.findViewById(R.id.editTextDate);
        //
        editTextPassword = view.findViewById(R.id.editUserPasswordInput);
        editTextLastName = view.findViewById(R.id.editNameUserInput);
    ...
    public void retrieveInput() {
        ...
        System.out.println(last_name + " " + pass + " " + first_name);
